        ...
        <div class="header-wrapper row m-0">
            <div class="header-logo-wrapper col-auto p-0">
                <div class="logo-wrapper">
                    <a href="index.php"><img class="img-fluid" src="<?=URL?>/admin/assets/images/logo/logo.png" alt=""></a>
                </div>
            </div>
    ...
    <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper">
            <div>
                <div class="logo-wrapper">
                    <a href="index.php">
                        <img class="img-fluid for-light" src="<?=URL?>/admin/assets/images/logo/small-logo.png" alt="">
                        <img class="img-fluid for-dark" src="<?=URL?>/admin/assets/images/logo/small-white-logo.png" alt="">
                    </a>
